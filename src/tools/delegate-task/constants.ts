...
1. Launch background agents to gather context:
   - task(subagent_type="explore", load_skills=[], description="Explore codebase patterns", run_in_background=true, prompt="<search for relevant patterns, files, and implementations in the codebase related to user's request>")
