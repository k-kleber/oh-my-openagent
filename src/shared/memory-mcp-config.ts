...
import type { SkillMcpConfig } from "../features/skill-mcp-manager/types"
...
export function createMemoryMcpConfig(): SkillMcpConfig {
  const openmemoryApiKey = getEnvOrSecretsValue("OPENMEMORY_API_KEY")?.trim() || "local-dev-key"
