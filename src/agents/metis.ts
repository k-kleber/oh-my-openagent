...
task(subagent_type="explore", load_skills=[], run_in_background=true, description="Find similar implementations", prompt="I'm analyzing a new feature request and need to understand existing patterns before asking clarifying questions. Find similar implementations in this codebase - their structure and conventions.")
task(subagent_type="explore", load_skills=[], run_in_background=true, description="Map feature organization", prompt="I'm planning to build [feature type] and want to ensure consistency with the project. Find how similar features are organized - file structure, naming patterns, and architectural approach.")
...
task(subagent_type="explore", load_skills=[], run_in_background=true, description="Inspect current implementation", prompt="I'm researching how to implement [feature] and need to understand the current approach. Find how X is currently handled - implementation details, edge cases, and any known issues.")
